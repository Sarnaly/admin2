...
<div class="p-2" style="background:#f5f5f5;"><a href="admission_form.php?page=admin_dashbord"><i class="fa-solid fa-gauge"></i>Dashboard / <i class="fa-solid fa-user-plus"></i>Admission Form</a></div>
</div>
